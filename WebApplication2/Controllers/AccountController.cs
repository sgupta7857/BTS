...
namespace WebApplication2.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        { 
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser() { UserName = model.UserName, Address = model.Address, FirstName = model.FirstName, LastName = model.LastName, PhoneNumber = model.PhoneNumber, Email = model.Email, IsEnabled = true };
        ...
        public async Task<ActionResult> Edit(UserUpdateViewModel userUpdateViewModel)
        {
            ...
            user.Address = userUpdateViewModel.Address;
            user.PhoneNumber = userUpdateViewModel.PhoneNumber; 
